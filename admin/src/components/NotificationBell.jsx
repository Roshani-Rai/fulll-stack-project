...
const NotificationBell = () => {
  ...
  const handleClick = (notif) => {
    markAsRead(notif.id)
    setOpen(false)
    if (['new_appointment', 'appointment_booked', 'appointment_cancelled', 'refund_requested', 'new_message'].includes(notif.type))
      navigate('/doctor-appointment')
    if (['payment_done', 'payment_received'].includes(notif.type))
