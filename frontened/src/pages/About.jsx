  ...
  return (
    <div className="flex justify-center px-4 sm:px-8 md:px-12 lg:px-20">
      <div className='w-full max-w-5xl'>
        ...
        <h1 className='w-full text-2xl my-8 text-center font-semibold text-gray-600'>
        ...
        <div className='my-10 flex flex-col md:flex-row gap-10 md:gap-12'>
          ...
          <div className='flex flex-col justify-center gap-6 text-sm text-gray-600'>
            ...
            <p className='text-gray-900 font-semibold text-base'>Our Vision</p>
            <p>
        ...
        {/* ✅ Now inside the wrapper — appears below, not beside */}
